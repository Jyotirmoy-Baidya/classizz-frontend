...
const AnnouncementNotificationBlock = ({ notification }) => {
    ...
    return (
        <div className='grid grid-cols-6 border-b-[1px] border-cyan-300 py-2 w-full notification-block-cls-announcement'>
            ...
            <div className='text-sm col-span-5 py-[0.1rem]'>
                <div className='text-gray-600 msg'>
                    ...
                    has made a new announcement in <span className='font-medium text-black'>{notification.class} </span>
                    .
                </div>
...
export default AnnouncementNotificationBlock