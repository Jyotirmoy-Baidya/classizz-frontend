...
const AcceptNotificationBlock = ({ notification }) => {
    ...
    return (
        <div className='grid grid-cols-6 border-b-[1px] border-cyan-300 py-2 w-full notification-block-accept'>
            ...
            <div className='text-sm col-span-5 py-[0.1rem]'>
                <div className='text-gray-600 msg'>
                    You have joined <span className='font-medium text-black'>{notification.personName}'s </span>
                    institute
                </div>
...
export default AcceptNotificationBlock